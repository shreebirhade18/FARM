...
//		driver.get("https://axiomuat.adanicapital.in/app/Applications/Queue/Open");
		...
		//Login Page
		driver.findElement(By.xpath("//input[@id='_username']")).sendKeys(new String[]{"60013100@adani.com"});		
...
//				CustomertypedropID.selectByVisibleText("Private Ltd");
//				Thread.sleep(300);
//				driver.findElement(By.xpath("//button[@type=\"submit\"]")).click();
//				
//				
...
//				//APPLICANT DETAILS  
//
//				driver.findElement(By.name("PAN.Number")).sendKeys(new String[] {"ZIQTP1999S"});
//				Thread.sleep(100);
...
//				s11.selectByVisibleText("Private Limited");
//				Thread.sleep(100);
...
//				driver.findElement(By.name("PAN.Number")).sendKeys(new String[] {"BICCD1602C"});
//				Thread.sleep(100);
//		        driver.findElement(By.xpath("//button[@class='btn btn-white']")).click();
//		        driver.findElement(By.xpath("//i[@class='fa fa-camera fa-2x text-primary']")).click();
//		        Thread.sleep(500);
