...
//		driver.get("https://axiomuat.adanicapital.in/app/Applications/Queue/Open");
		...
		driver.findElement(By.xpath("//button[@id=\"kt_aside_desktop_toggle\"]")).click();	
     	...
     	//APPLICATION INFO
				...
				Thread.sleep(100);
				driver.findElement(By.id("Customer_LastName")).sendKeys(new String[] {"Sharma0001"});
				Thread.sleep(100);
...
//				driver.findElement(By.xpath("btn btn-white text-primary")).click();
				...
				s2.selectByVisibleText("ICV Refinance");
				Thread.sleep(3000);
...
//				Thread.sleep(2000);
				...
				//Open Queue
				  ...
				  driver.findElement(By.xpath("//*[@id=\"kt_aside_menu\"]/ul/li[2]/div/ul/li[3]/a/span")).click();
		   		driver.findElement(By.xpath("//*[@id=\"table_filter\"]/label/input")).sendKeys(new String[]{"Sharma0001"});
		   		Thread.sleep(4000);
