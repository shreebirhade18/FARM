...
//		driver.get("https://axiomuat.tyger.in/onboard-backoffice/CVLoanApplicationStep/StepCharges/294409");
//		driver.get("https://axiomuat.tyger.in/onboard-backoffice");
		Thread.sleep(1000);

		// Login Page
		driver.findElement(By.xpath("//input[@id='_username']")).sendKeys(new String[] { "30021727@tyger.in" });
...
//		Thread.sleep(100);
//		driver.findElement(By.id("Customer_LastName")).sendKeys(new String[] { "Varthak012" });
//		Thread.sleep(100);
...
//		driver.findElement(By.xpath("//button[@class='btn btn-sm btn-primary']")).click();
//		Thread.sleep(6000);
//		WebElement GapplicantAddressproof = driver
//				.findElement(By.xpath("//select[@name=\"AddressProof.IdentificationTypeID\"]"));
//		Thread.sleep(1000);
...
//		Thread.sleep(100);
//
//		WebElement Gapplicantqualification = driver
//				.findElement(By.name("CustomerAdditionalDetails.EducationalQualificationID"));
//		Thread.sleep(500);
...
//		Thread.sleep(100);
//
//		WebElement Gapplicantlanguage = driver
//				.findElement(By.name("CustomerAdditionalDetails.CommunicationLanguageID"));
//		Thread.sleep(500);
...
//		Thread.sleep(500);
//
//		WebElement Gapplicantrelation = driver
//				.findElement(By.name("CustomerAdditionalDetails.RelationshipWithApplicant"));
//		Thread.sleep(500);
...
//				 driver.findElement(By.id("FirstInstallmentDate")).sendKeys(new String[] {"05-Oct-2024"});
//				 driver.findElement(By.xpath("//*[@id=\"confirmTenureModal\"]/div/div/div/div/button[1]")).click();
//				 
//			     //NEXT PAGE
//				 driver.findElement(By.xpath("//*[@id=\"vapp\"]/form/div[1]/div[4]/button")).click();
//				 
//				 
//					Thread.sleep(3000);
//
...
//				
		...
		driver.findElement(By.xpath("//*[@id=\"table_filter\"]/label/input")).sendKeys(new String[] { "Varthak012" });
		Thread.sleep(4000);
...
//					driver.findElement(By.xpath("//*[@id=\"vs2__listbox\"]")).click();
		...
		action1111.sendKeys(Keys.ENTER).build().perform();
