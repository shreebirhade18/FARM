...
//				Thread.sleep(100);
//				driver.findElement(By.id("Customer_LastName")).sendKeys(new String[] {"Verma010"});
//				Thread.sleep(100);
...
//				
//				//NEXT STAGE
//				driver.findElement(By.xpath("//*[@id=\"vapp\"]/div[2]/form/div/button")).click();
//				Thread.sleep(2000);	
//				
...
//				s2.selectByVisibleText("HCV Used");
//				Thread.sleep(3000);
//				
...
//		   		driver.findElement(By.xpath("//*[@id=\"table_filter\"]/label/input")).sendKeys(new String[]{"Verma010"});
//		   		Thread.sleep(4000);
...
//					
//					driver.findElement(By.xpath("//*[@id=\"product-rules-app\"]/div[8]/div[3]/div/div/button")).click();
//					Thread.sleep(4000);
//					
//					//Open Queue
//					  
