...
//		driver.get("https://axiomuat.adanicapital.in/onboard/backoffice");
		...
		driver.findElement(By.xpath("//button[@id=\"kt_aside_desktop_toggle\"]")).click();	
     	...
     	//APPLICATION INFO
				...
				Thread.sleep(100);
				driver.findElement(By.id("Customer_LastName")).sendKeys(new String[] {"Varthak015"});
				Thread.sleep(100);
...
//				Thread.sleep(2000);	
				...
				StringSelection filepath2= new StringSelection("C:\\Users\\Chinmay.surve\\eclipse-workspace\\Upload-Document\\Statement.pdf");
				...
				//Open Queue
				  ...
				  driver.findElement(By.xpath("//*[@id=\"kt_aside_menu\"]/ul/li[2]/div/ul/li[3]/a/span")).click();
		   		driver.findElement(By.xpath("//*[@id=\"table_filter\"]/label/input")).sendKeys(new String[]{"Varthak015"});
		   		Thread.sleep(4000);
