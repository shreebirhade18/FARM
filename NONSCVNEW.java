...
//		driver.get("https://axiomuat.adanicapital.in/app/Applications/Queue/Open");
		driver.get("https://axiomuat.tyger.in/onboard-backoffice/CVLoanApplicationStep/StepUpdateStakeHolder/294457?sid=564071");
		Thread.sleep(1000);
...
////		    	Thread.sleep(5000);				  
//
//		       	driver.findElement(By.id("CompanyBasicDetail_NameOfEntity")).sendKeys(new String[] {"Adaniscvnon010"});
//
//		 
//				
...
//				Thread.sleep(100);
//				driver.findElement(By.id("CompanyBasicDetail_RegistrationNo")).sendKeys(new String[] {"Adaniscvnon010"});
//				Thread.sleep(100);
//				
...
//				Thread.sleep(2000);
				...
				driver.findElement(By.xpath("//*[@id=\"vapp\"]/form/div/div[2]/button")).click();
				Thread.sleep(5000);
				...
				//Open Queue
				  ...
				  driver.findElement(By.xpath("//*[@id=\"kt_aside_menu\"]/ul/li[2]/div/ul/li[3]/a/span")).click();
		   		driver.findElement(By.xpath("//*[@id=\"table_filter\"]/label/input")).sendKeys(new String[]{"Adaniscvnon010"});
		   		Thread.sleep(4000);
		   		...
		   		driver.findElement(By.xpath("//*[@id=\"ApplicationSelectionForm\"]/button")).click();
					...
					driver.findElement(By.xpath("//*[@id=\"ResidentStabilityInMonths\"]")).clear();
					driver.findElement(By.xpath("//*[@id=\"ResidentStabilityInMonths\"]")).sendKeys("20");
...
//					driver.findElement(By.xpath("//*[@id=\"vs2__listbox\"]")).click();
					...
					driver.findElement(By.xpath("//*[@id=\"disbursement-configuration-app\"]/div[3]/div[2]/div[1]/div[4]/input")).sendKeys("500000");
