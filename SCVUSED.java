...
//		driver.get("https://axiomuat.adanicapital.in/onboard/backoffice");
		...
		//Login Page
		driver.findElement(By.xpath("//input[@id='_username']")).sendKeys(new String[]{"30021727@adani.com"});		
		driver.findElement(By.xpath("//input[@id='Password']")).sendKeys(new String[] {"Adani@1234"});
...
//				driver.findElement(By.name("PAN.Number")).sendKeys(new String[] {"BIQPN9999Q"});
//				Thread.sleep(100);
...
//		    	Thread.sleep(3000);				  
//		    	driver.findElement(By.id("Customer_FirstName")).sendKeys(new String[] {"Avinash"});
//				Thread.sleep(100);
//				driver.findElement(By.id("Customer_LastName")).sendKeys(new String[] {"Verma012"});
//				Thread.sleep(100);
...
//				Thread.sleep(2000);
//		 
//				driver.findElement(By.name("Contact.Mobile")).sendKeys(new String[] {"7020773456"});
//				Thread.sleep(1000);
//				
//				//NEXT PAGE
...
//				driver.findElement(By.name("PAN.Number")).sendKeys(new String[] {"BICST1602Q"});
//				Thread.sleep(100);
//		        driver.findElement(By.xpath("//button[@class='btn btn-white']")).click();
//		        driver.findElement(By.xpath("//i[@class='fa fa-camera fa-2x text-primary']")).click();
//		        Thread.sleep(500);
...
//				Thread.sleep(500);
//		 
//				driver.findElement(By.name("Contact.Mobile")).sendKeys(new String[] {"7020773457"});
//				Thread.sleep(500);
//				
//				//Next stage
//				driver.findElement(By.xpath("//button[@class='btn text-white float-right mr-2']")).click();
...
//				Thread.sleep(2000);
//				
//				 WebElement GapplicantIDproof = driver.findElement(By.xpath("//select[@name=\"IDProof.IdentificationTypeID\"]"));
//					Thread.sleep(100);
//					Select GapplicantIDproof1=new Select(GapplicantIDproof);
//					GapplicantIDproof1.selectByVisibleText("PAN");
...
//			        driver.findElement(By.xpath("//button[@class='btn btn-sm btn-primary']")).click();
//			        Thread.sleep(6000);
//			        WebElement GapplicantAddressproof = driver.findElement(By.xpath("//select[@name=\"AddressProof.IdentificationTypeID\"]"));
//			       	Thread.sleep(1000);
//			      	Select GapplicantAddressproofID=new Select(GapplicantAddressproof);
//			      	GapplicantAddressproofID.selectByVisibleText("Voter ID");
//			      	Thread.sleep(500);
//			      	driver.findElement(By.name("AddressProof.Number")).sendKeys(new String[] {"BIQPN1602Q"});   	    
//			      	Thread.sleep(1000);  	 
//			      	driver.findElement(By.xpath("(//button[@class='btn btn-white'])[2]")).click();
...
//					Thread.sleep(100);
//			 
//					WebElement GapplicantGender = driver.findElement(By.id("Customer_Gender"));
//					Thread.sleep(100);
//					Select GapplicantGenderID=new Select(GapplicantGender);
//					GapplicantGenderID.selectByIndex(1);
//			 
//					driver.findElement(By.id("CurrentAddress_AddressLine1")).sendKeys(new String[] {"Rupa Renaissance"});
//					Thread.sleep(100);
//					driver.findElement(By.id("CurrentAddress_AddressLine2")).sendKeys(new String[] {"Post- Dighashi"});
...
//					Thread.sleep(100);
//			 
//					WebElement Gapplicantcurrentdist = driver.findElement(By.name("CurrentAddress.District"));
//					Thread.sleep(500);
//					Select GapplicantcurrentdistID=new Select(Gapplicantcurrentdist);
//					GapplicantcurrentdistID.selectByVisibleText("AHMEDABAD");
//					Thread.sleep(500);
//			 
//					WebElement Gapplicantcurrenttaluka = driver.findElement(By.name("CurrentAddress.AddressLine3"));
//					Thread.sleep(500);
//					Select GapplicantcurrenttalukaID=new Select(Gapplicantcurrenttaluka);
//					GapplicantcurrenttalukaID.selectByVisibleText("Ahmadabad City");
//					Thread.sleep(500);
//			 
//					WebElement Gapplicantcurrentvillage = driver.findElement(By.name("CurrentAddress.Village"));
//					Thread.sleep(500);
//					Select GapplicantcurrentvillageID=new Select(Gapplicantcurrentvillage);
//					GapplicantcurrentvillageID.selectByVisibleText("Bhadaj");
//					Thread.sleep(500);
//			 
//					driver.findElement(By.name("CurrentAddress.Landmark")).sendKeys(new String[] {"Near BOB"});
//			 
//					WebElement GapplicantResidencetype = driver.findElement(By.name("CurrentAddress.ResidenceTypeID"));
//					Thread.sleep(500);
//					Select GapplicantResidencetypeID=new Select(GapplicantResidencetype);
//					GapplicantResidencetypeID.selectByVisibleText("Owned");
//			 
//					driver.findElement(By.id("IsSameAsCurrentAddress")).click();
//					Thread.sleep(500);
//			 
...
//				driver.findElement(By.xpath("(//button[@class='btn btn-sm btn-primary'])[1]")).click();
//				Thread.sleep(1000);
//				WebElement Gapplicantmarital = driver.findElement(By.name("CustomerAdditionalDetails.MaritalStatusID"));
//				Thread.sleep(500);
//				Select GapplicantmaritalID=new Select(Gapplicantmarital);
//				GapplicantmaritalID.selectByVisibleText("Single");
//				Thread.sleep(100);
//					 
//					 
//				WebElement Gapplicantqualification = driver.findElement(By.name("CustomerAdditionalDetails.EducationalQualificationID"));
//				Thread.sleep(500);
//				Select GapplicantqualificationID=new Select(Gapplicantqualification);
//				GapplicantqualificationID.selectByVisibleText("Graduate");
//				Thread.sleep(100);
//					 
//				WebElement Gapplicantlanguage = driver.findElement(By.name("CustomerAdditionalDetails.CommunicationLanguageID"));
//				Thread.sleep(500);
//				Select GapplicantlanguageID=new Select(Gapplicantlanguage);
//				GapplicantlanguageID.selectByVisibleText("Hindi");
//				Thread.sleep(100);
//					 
//				driver.findElement(By.name("CustomerAdditionalDetails.NumberOfDependents")).sendKeys(new String[] {"2"});
//				Thread.sleep(200);
...
//				Thread.sleep(200);
//					 
//				WebElement Gapplicantcaste = driver.findElement(By.name("CustomerAdditionalDetails.CasteID"));
//				Thread.sleep(100);
//				Select GapplicantcasteID=new Select(Gapplicantcaste);
//				GapplicantcasteID.selectByVisibleText("General");
//				Thread.sleep(100);
//					 
//				WebElement Gapplicantreligion = driver.findElement(By.name("CustomerAdditionalDetails.ReligionID"));
//				Thread.sleep(500);
//				Select GapplicantreligionID=new Select(Gapplicantreligion);
//				GapplicantreligionID.selectByVisibleText("Hindu");
//				Thread.sleep(500);
//							  
//				WebElement Gapplicantrelation = driver.findElement(By.name("CustomerAdditionalDetails.RelationshipWithApplicant"));
//				Thread.sleep(500);
//				Select GapplicantrelationID=new Select(Gapplicantrelation);
//				GapplicantrelationID.selectByVisibleText("Brother");
//				Thread.sleep(500);
//							  
//							  
//				WebElement Gapplicantaddresstab = driver.findElement(By.xpath("//A[@id='address-tab']"));
//				Actions GapplicantaddresstabID = new Actions(driver);
//				GapplicantaddresstabID.moveToElement(Gapplicantaddresstab);
//				GapplicantaddresstabID.click(Gapplicantaddresstab);
//				GapplicantaddresstabID.build().perform();
//				driver.findElement(By.xpath("//input[@id='CurrentAddress_YearsInCurrentResidence']")).sendKeys("15");
//				Thread.sleep(500);
//				driver.findElement(By.xpath("//input[@id='CurrentAddress_DistanceFromBranch']")).sendKeys("20");
//				Thread.sleep(500);
...
//				
//							  
//				WebElement Gapplicantcontacttab1 = driver.findElement(By.xpath("//a[@id='contact-tab']"));
//				Actions Gapplicantcontacttab1ID = new Actions(driver);
//				Gapplicantcontacttab1ID.moveToElement(Gapplicantcontacttab1);
//				Gapplicantcontacttab1ID.click(Gapplicantcontacttab1);
//				Gapplicantcontacttab1ID.build().perform();
//							  
//				WebElement GapplicantMobileNumberType = driver.findElement(By.name("MobileNumberTypeID"));
//				Thread.sleep(500);
//				Select GapplicantMobileNumberTypeID=new Select(GapplicantMobileNumberType);
//				GapplicantMobileNumberTypeID.selectByValue("431");
//				Thread.sleep(500);
//							  
//				driver.findElement(By.xpath("//button[@class='btn text-white float-right mr-2']")).click();
//				Thread.sleep(6000);
...
//				Thread.sleep(2000);
//				driver.findElement(By.id("NameOfCurrentOwner")).sendKeys(new String[] {"Chinmay"});
//				Thread.sleep(100);
//				driver.findElement(By.id("SalePrice")).sendKeys(new String[] {"600000"});
//				Thread.sleep(100);
...
//				 driver.findElement(By.xpath("//input[@id=\"ROI\"]")).sendKeys(new String[] {"19"});
...
//		   		driver.findElement(By.xpath("//*[@id=\"table_filter\"]/label/input")).sendKeys(new String[]{"Verma012"});
//		   		Thread.sleep(4000);
...
//					 //Gurantor tab
//	        		
//					WebElement FIGurantor = driver.findElement(By.xpath("(//span[@class='nav-text'])[7]"));
//					Actions FIGurantortab = new Actions(driver);
//					FIGurantortab.moveToElement(FIGurantor);
//					FIGurantortab.click(FIGurantor);
//					FIGurantortab.build().perform();
//							        		
//							        		
//							        		
...
//					Thread.sleep(1000);
//							        		
//					driver.findElement(By.xpath("//*[@id=\"Guarantors_0__AreaSqFt\"]")).clear();
//					driver.findElement(By.xpath("//*[@id=\"Guarantors_0__AreaSqFt\"]")).sendKeys("900");
//					Thread.sleep(2000);
//							        		
//					WebElement Gurantorcheck = driver.findElement(By.name("Guarantors[0].NeighborCheck"));
//					Thread.sleep(300);
//					Select GurantorcheckID=new Select(Gurantorcheck);
//					GurantorcheckID.selectByVisibleText("Positive");
//							        		
//							        		
...
//							        		
//							        		
//					WebElement Gurantornegativecheck = driver.findElement(By.name("Guarantors[0].NegativeProfile"));
//					Thread.sleep(300);
//					Select GurantornegativecheckID=new Select(Gurantornegativecheck);
//					GurantornegativecheckID.selectByVisibleText("No");
//					Thread.sleep(1000);
//		
//					
//					
...
//					Thread.sleep(4000);
					...
					driver.findElement(By.xpath("//*[@id=\"select2-RegisteredVehicleOwnerAddress_PincodeId-results\"]/li")).click();
					Thread.sleep(1000);
					...
					driver.findElement(By.xpath("//*[@id=\"disbursement-configuration-app\"]/div[3]/div[2]/div[1]/div[4]/input")).sendKeys("400000");
