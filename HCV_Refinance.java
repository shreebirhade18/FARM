...
//			driver.get("https://axiomuat.adanicapital.in/onboard/backoffice/CVLoanApplicationStep/StepCVDocuments/119155");
//			driver.get("https://axiomuat.adanicapital.in/app/Applications/Queue/Open");
			...
			driver.findElement(By.xpath("//button[@id=\"kt_aside_desktop_toggle\"]")).click();	
	     	...
	     	//APPLICATION INFO
					...
					Thread.sleep(100);
					driver.findElement(By.id("Customer_LastName")).sendKeys(new String[] {"SharmaC1"});
					Thread.sleep(100);
...
//					Thread.sleep(2000);
					...
					//Open Queue
					  ...
					  driver.findElement(By.xpath("//*[@id=\"kt_aside_menu\"]/ul/li[2]/div/ul/li[3]/a/span")).click();
			   		driver.findElement(By.xpath("//*[@id=\"table_filter\"]/label/input")).sendKeys(new String[]{"SharmaC1"});
			   		Thread.sleep(4000);
			   		...
			   		driver.findElement(By.xpath("//*[@id=\"ApplicationSelectionForm\"]/button")).click();
						...
						//Location
						driver.findElement(By.xpath("//*[@id=\"fi_result_tab\"]/div[3]/div[3]/div/button")).click();
						Thread.sleep(5000);
