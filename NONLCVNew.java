...
//		driver.get("https://axiomuat.adanicapital.in/onboard/backoffice/CVLoanApplicationStep/StepCVDocuments/119244");
		Thread.sleep(1000);
...
//		    	Thread.sleep(5000);				  
		       	...
		       	driver.findElement(By.id("CompanyBasicDetail_NameOfEntity")).sendKeys(new String[] {"Adaniscvnon001"});
				...
				Thread.sleep(100);
				driver.findElement(By.id("CompanyBasicDetail_RegistrationNo")).sendKeys(new String[] {"Adaniscvnon001"});
				Thread.sleep(100);
...
//				Thread.sleep(300);
				...
				s2.selectByVisibleText("LCV New");
				Thread.sleep(3000);
...
//				Thread.sleep(2000);
				...
				//Open Queue
				  ...
				  driver.findElement(By.xpath("//*[@id=\"kt_aside_menu\"]/ul/li[2]/div/ul/li[3]/a/span")).click();
		   		driver.findElement(By.xpath("//*[@id=\"table_filter\"]/label/input")).sendKeys(new String[]{"Adaniscvnon001"});
		   		Thread.sleep(4000);
