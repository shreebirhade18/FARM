...
//		driver.get("https://axiomuat.tyger.in/origination-app/Applications/Queue/Open");
		driver.get("https://axiomuat.tyger.in/onboard-backoffice/FarmLoanApplicationStep/StepNewAssetDetails/294659");
		Thread.sleep(1000);
...
//		
		...
		driver.findElement(By.name("PAN.Number")).sendKeys(new String[] {"TVSPN1602Q"});
		Thread.sleep(100);
		...
		Thread.sleep(1000);
		driver.findElement(By.id("Customer_LastName")).sendKeys(new String[] {"Jadhav"});
		Thread.sleep(1000);
...
//		driver.findElement(By.xpath("btn btn-white text-primary")).click();
		...
		WebElement DROP4 = driver.findElement(By.name("ProductTypeID"));
		Thread.sleep(300);
		Select s4=new Select(DROP4);
		s4.selectByVisibleText("New");
 
		WebElement DROP5 = driver.findElement(By.name("SchemeTypeID"));
		Thread.sleep(300);
		Select s5=new Select(DROP5);
		s5.selectByIndex(1);
 
		WebElement DROP6 = driver.findElement(By.id("PromotionalSchemeID"));
		Thread.sleep(300);
		Select s6=new Select(DROP6);
		s6.selectByVisibleText("External BT 3rd Party");
 
		WebElement DROP7 = driver.findElement(By.id("LeadSourceID"));
		Thread.sleep(500);
		Select s7=new Select(DROP7);
		s7.selectByVisibleText("Self Sourcing");
        Thread.sleep(500);
...
//		Thread.sleep(500);
		...
		driver.findElement(By.xpath("//input[@name=\"OtherIncome\"]")).sendKeys("1000000");
		Thread.sleep(3000);
				  
		driver.findElement(By.xpath("//input[@name=\"OtherExpense\"]")).sendKeys("200000");
		Thread.sleep(3000);
		...
		driver.findElement(By.id("FirstInstallmentDate")).sendKeys(new String[] {"05-Nov-2024"});
		Thread.sleep(2000);
...
//		driver.findElement(By.xpath("//*[@id=\"documentTab0\"]/div/div/div/div/div/div[3]/div[1]/div/div/div/button/span")).click();
		...
		driver.findElement(By.xpath("//*[@id=\"table_filter\"]/label/input")).sendKeys(new String[]{"Jadhav"});
		Thread.sleep(4000);
...
//				    			
		...
		driver.findElement(By.xpath("(//button[@class='dropdown-item'])[4]")).click();
		Thread.sleep(6000);
//		//CreditL4
...
//		driver.findElement(By.xpath("//*[@id=\"vs2__listbox\"]")).click();
		...
		action15.sendKeys(Keys.ARROW_DOWN).sendKeys(Keys.ENTER).build().perform();
		Thread.sleep(2000);
...
//		action88.sendKeys(Keys.ENTER).build().perform();
		...
		Actions action188 = new Actions(driver);
		action188.sendKeys(Keys.ENTER).build().perform();
		...
		Actions action189 = new Actions(driver);
		action189.sendKeys(Keys.ENTER).build().perform();
		...
		Actions action182 = new Actions(driver);
		action182.sendKeys(Keys.ENTER).build().perform();
